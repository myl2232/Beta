...
#ifndef CY_STANDARD_SHADOW_INCLUDED
#define CY_STANDARD_SHADOW_INCLUDED
...
half CustomCompositeSetup_ShadowGetOneMinusReflectivity(half2 uv)
{
    half3 mg;
    mg.rgb = tex2D(_CustomCompositeMap, uv).rgb;
    return OneMinusReflectivityFromMetallic(mg.r);
}
