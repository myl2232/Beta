...
{
    public static string saveDir = Application.dataPath + "/AlphaWork/3rd/ToLua/Source/Generate/";    
    public static string toluaBaseType = Application.dataPath + "/AlphaWork/3rd/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/AlphaWork/3rd/Tolua/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/AlphaWork/3rd/ToLua/Injection/";
    ...
    {                
        ...
        _GT(typeof(AlphaWork.UIAttack1EventArgs)),
        _GT(typeof(AlphaWork.UIAttack2EventArgs)),
        _GT(typeof(AlphaWork.UIAlphaEventArgs)),
        _GT(typeof(AlphaWork.UIBetaEventArgs)),
        _GT(typeof(AlphaWork.UIThetaEventArgs)),
