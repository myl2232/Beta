...
namespace AlphaWork
{
    ...
    public class PrefabLightmap : MonoBehaviour
    {
        ...
        string LIGHTMAP_RESOURCE_PATH = "Assets/Resources/Lightmaps/";
        ...
        {
            LIGHTMAP_RESOURCE_PATH = Application.dataPath + "//AlphaWork//Scenes//" + SceneManager.GetActiveScene().name;            
        }
        ...
        {
            PrefabLightmap[] prefabs = FindObjectsOfType<PrefabLightmap>();
