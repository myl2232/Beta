...
namespace AlphaWork
{
    public class SurvivalGame : GameBase
    {
        ...
        {
            RecordPlayer((MainEthan.Handle as GameObject).transform.position);
        ...
        public void OnRefreshMainPos(object sender, GameEventArgs e)
        {
            ...
            if (arg != null && MainActor.gameObject == arg.Gb)
            {
                ...
                RecordPlayer(arg.Gb.transform.position);
            }
        }

        protected void RecordPlayer(Vector3 position)
        {
