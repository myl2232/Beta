...
namespace AlphaWork
{
    ...
    public class RPGCharacterControllerFREE : BaseCharacter
    {
        #region Variables

        //Components
        private JoystackCc m_Joystack;//myl
        Rigidbody rb;
        ...
        void Inputs()
        {
            ...
            // 		inputCastR = Input.GetButtonDown("CastR") ? Input.GetButtonDown("CastR") : inputCastR;
