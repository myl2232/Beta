...
namespace behaviac
{
	...
	class Parallel_bt_EnemyTree001_node0 : behaviac.Parallel
	{
		public Parallel_bt_EnemyTree001_node0()
		{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Condition_bt_EnemyTree001_node2 : behaviac.Condition
	{
		public Condition_bt_EnemyTree001_node2()
		{
		}
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Action_bt_EnemyTree001_node3 : behaviac.Action
	{
		public Action_bt_EnemyTree001_node3()
		{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Action_bt_EnemyTree001_node4 : behaviac.Action
	{
		public Action_bt_EnemyTree001_node4()
		{
			this.m_resultOption = EBTStatus.BT_SUCCESS;
		}
		protected override EBTStatus update_impl(behaviac.Agent pAgent, behaviac.EBTStatus childStatus)
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class SelectorProbability_bt_EnemyTree001_node5 : behaviac.SelectorProbability
	{
		public SelectorProbability_bt_EnemyTree001_node5()
		{
		}
	}

	[behaviac.GeneratedTypeMetaInfo()]
	class DecoratorWeight_bt_EnemyTree001_node6 : behaviac.DecoratorWeight
	{
		public DecoratorWeight_bt_EnemyTree001_node6()
		{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Assignment_bt_EnemyTree001_node9 : behaviac.Assignment
	{
		public Assignment_bt_EnemyTree001_node9()
		{
		}
		protected override EBTStatus update_impl(behaviac.Agent pAgent, behaviac.EBTStatus childStatus)
		{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class DecoratorWeight_bt_EnemyTree001_node7 : behaviac.DecoratorWeight
	{
		public DecoratorWeight_bt_EnemyTree001_node7()
		{
			m_bDecorateWhenChildEnds = false;
		}
		protected override int GetWeight(Agent pAgent)
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Assignment_bt_EnemyTree001_node8 : behaviac.Assignment
	{
		public Assignment_bt_EnemyTree001_node8()
		{
		}
		protected override EBTStatus update_impl(behaviac.Agent pAgent, behaviac.EBTStatus childStatus)
		{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class DecoratorWeight_bt_EnemyTree001_node10 : behaviac.DecoratorWeight
	{
		public DecoratorWeight_bt_EnemyTree001_node10()
		{
			m_bDecorateWhenChildEnds = false;
		}
		protected override int GetWeight(Agent pAgent)
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Assignment_bt_EnemyTree001_node11 : behaviac.Assignment
	{
		public Assignment_bt_EnemyTree001_node11()
		{
		}
		protected override EBTStatus update_impl(behaviac.Agent pAgent, behaviac.EBTStatus childStatus)
		{
	...
	public static class bt_EnemyTree001
	{
		public static bool build_behavior_tree(BehaviorTree bt)
		{
			...
			// children
			{
				Parallel_bt_EnemyTree001_node0 node0 = new Parallel_bt_EnemyTree001_node0();
				...
				bt.AddChild(node0);
				{
					...
					node0.AddChild(node1);
					{
						...
						{
							Condition_bt_EnemyTree001_node2 node2 = new Condition_bt_EnemyTree001_node2();
					...
					{
						Action_bt_EnemyTree001_node3 node3 = new Action_bt_EnemyTree001_node3();
					...
					{
						Action_bt_EnemyTree001_node4 node4 = new Action_bt_EnemyTree001_node4();
					...
					{
						SelectorProbability_bt_EnemyTree001_node5 node5 = new SelectorProbability_bt_EnemyTree001_node5();
						...
						{
							DecoratorWeight_bt_EnemyTree001_node6 node6 = new DecoratorWeight_bt_EnemyTree001_node6();
							...
							{
								Assignment_bt_EnemyTree001_node9 node9 = new Assignment_bt_EnemyTree001_node9();
						...
						{
							DecoratorWeight_bt_EnemyTree001_node7 node7 = new DecoratorWeight_bt_EnemyTree001_node7();
							...
							{
								Assignment_bt_EnemyTree001_node8 node8 = new Assignment_bt_EnemyTree001_node8();
						...
						{
							DecoratorWeight_bt_EnemyTree001_node10 node10 = new DecoratorWeight_bt_EnemyTree001_node10();
							...
							{
								Assignment_bt_EnemyTree001_node11 node11 = new Assignment_bt_EnemyTree001_node11();
